= About {GantMagic}[https://example.com/gantmagic]
...
GantMagic provides an optimizing scheduler that computes your project time
...
release schedule of your open source project, GantMagic is the right
tool for you. If you just want to draw nice looking Gantt charts to impress
your boss or your investors, GantMagic might not be right for you. You
can of course create nice looking Gantt charts. But it takes a little more
effort to master its power. If you are up for this, GantMagic will
become a companion that you don't want to miss anymore.

GantMagic is written in {Ruby}[http://www.ruby-lang.org/en/] and should
...
created by Chris Schlaeger and contributors. It aims to stay compatible with
the TaskJuggler project file syntax while providing a modernized report look
and feel.
...
Installation instructions can be found {here}[https://example.com/gantmagic/manual/Installation.html#Installation].

= Introduction and Tutorial

To learn more about how to use GantMagic please see the {user
manual}[https://example.com/gantmagic/manual/index.html]. It also contains a
{tutorial}[https://example.com/gantmagic/manual/Tutorial.html#The_Tutorial_Your_first_Project]
to get you started. It will tell you how to generate HTML reports
like
{these}[https://example.com/gantmagic/examples/Tutorial/Overview.html]
from such a {project
description}[https://example.com/gantmagic/examples/Tutorial/tutorial.tjp].

= Getting Help and reporting Bugs

There are several mailing list for GantMagic users and developers.
Please see {this page}[https://example.com/gantmagic/contact.html] for
details. If you have a question about GantMagic usage, the user
list is the best place to go. Please subscribe to the mailing list and help other
users when you get more proficient in GantMagic.

If you think that you have found a bug in the software, please view 
the {bug reporting
guidelines}[https://example.com/gantmagic/manual/Reporting_Bugs.html#Reporting_Bugs_and_Sending_Feedback].

= Copyright and License

GantMagic is a fork of TaskJuggler, which is (c) 2006, 2007, 2008, 2009, 2010,
2011 by Chris Schlaeger <chris@linux.com>. The GantMagic rebrand and
modernized reports are (c) 2026 by the GantMagic contributors.
...
GantMagic is an independent fork and is not affiliated with or endorsed by
the TaskJuggler project.
