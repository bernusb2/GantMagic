# -*- coding: utf-8 -*-
#
# = gantmagic.gemspec -- The GantMagic Project Management Software
#
...
#
# This gemspec file will be used to package the gantmagic gem. Before you
...
GEM_SPEC = Gem::Specification.new { |s|
  ...
  s.homepage = 'https://example.com/gantmagic'
  s.author = 'Chris Schlaeger'
  s.email = 'chris@linux.com'
  s.summary = 'A Project Management Software'
  s.description = <<'EOT'
GantMagic is a modern and powerful, Free and Open Source Software project
...
GantMagic is project management software for serious project managers. It
...
GantMagic is a fork of the TaskJuggler project (http://www.taskjuggler.org),
...
EOT
  ...
  s.files = (`git ls-files -- lib`).split("\n") +
            ...
            %w( .gemtest gantmagic.gemspec Rakefile ) +
