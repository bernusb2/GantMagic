...
named .gantmagicrc or gantmagic.rc that contains at least the following
...
EOT
      ...
      if @port == 0 && @uriFile
        ...
        # the file .gmd.uri. gmclient will look for it.
        begin
      ...
      if @port == 0 && @uriFile
        begin
          ...
          error('cannot_delete_uri', "Cannot delete URI file .gmd.uri: #{$!}")
        end
      end
